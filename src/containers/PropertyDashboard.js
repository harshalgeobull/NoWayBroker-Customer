      ...
      <div className="flex flex-col p-1 space-y-4 sm:p-6 bg-rose-50 rounded-xl">
        ...
        <div className="flex flex-col flex-wrap items-center justify-center gap-4 md:flex-row md:items-center">
          ...
          <div className="flex flex-wrap w-full gap-2 mt-2 md:w-auto">
            {/* Property category Type Dropdown */}
            <div className="w-full sm:w-[150px]">
              <select
                ...
                className="w-full h-14 p-2 border-2 border-gray-300 rounded-md"
              >
            ...
            <div className="w-full sm:w-[160px]">
              <select
                ...
                className="w-full h-14 p-2 border-2 border-gray-300 rounded-md focus:outline-none hover:bg-gray-300"
              >
            ...
            <div className="relative w-full sm:w-[190px]">
              <button
                ...
                className="flex items-center justify-between w-full h-14 px-4 bg-white border-2 border-gray-300 rounded-md"
              >
            ...
            {/* Budget Dropdown */}
            <div className="relative w-full sm:w-36 md:w-44">
              <button
                onClick={togglePriceDropdown}
                className="flex items-center justify-between w-full h-14 px-4 bg-white border-2 border-gray-300 rounded-md focus:outline-none hover:bg-gray-300"
              >
                <span>
                  {minPrice && maxPrice
            ...
            <div className="w-full sm:w-[180px]">
              <div className="flex items-center h-14 overflow-hidden bg-white border-2 border-gray-300 rounded-md">
                <button
                  type="button"
            ...
            <div className="relative w-full sm:w-[240px]">
              <button
                ...
                className="flex items-center justify-between w-full h-14 p-2 bg-white border-2 border-gray-300 rounded-md focus:outline-none hover:bg-gray-300"
              >
                <span>
