...
const handleMapNext = (propertyId, totalImages) => {
  ...
  const visibleProperties = sortedProperties.filter(
...
<div className="flex items-center justify-between px-6 mt-4 mb-3 max-[767px]:flex-col max-[767px]:items-stretch max-[767px]:gap-2 max-[767px]:px-3">
  ...
  <div className="flex gap-4 max-[767px]:gap-2 max-[767px]:w-full">
    <button
      onClick={handleButtonClick}
      className="w-40 p-3 text-rose-700 my-border rounded-md hover:bg-gray-300 focus:outline-none max-[767px]:flex-1 max-[767px]:w-auto max-[767px]:py-2 max-[767px]:px-2 max-[767px]:text-xs"
    >
      {filtersApplied ? "Reset Filters" : "Apply Filter"}
    </button>

    <button
      className="w-40 p-3 my-border rounded-md hover:bg-gray-300 focus:outline-none max-[767px]:flex-1 max-[767px]:w-auto max-[767px]:py-2 max-[767px]:px-2 max-[767px]:text-xs"
      onClick={handleSaveSearch}
    >
      Save Search
    </button>
      ...
      {/* Main Content — unchanged, cards/map/pagination logic and existing responsive card styling untouched */}
