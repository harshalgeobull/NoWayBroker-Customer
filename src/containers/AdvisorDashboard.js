...
//               {/* <div className="w-full mb-3 sm:w-100">
//                       <div className="relative w-full h-48 overflow-hidden shadow-md rounded-2xl">
//                         <img
//                           src="/image/r1.jpg" // Replace with your actual image
//                           alt="Advertisement"
//                           className="object-cover w-full h-full"
//                         />
//                         <div className="absolute inset-0 flex items-center justify-center bg bg-opacity-30">
...
//                          ${currentPage === page ? "rounded-full my-border w-8 h-8 flex items-center justify-center font-normal" : "text-gray-700"}
//                        `}
//                     >
//                       {page}
//                     </button>
...
import { FaMapMarkerAlt } from "react-icons/fa";
import { BiArea } from "react-icons/bi";
import { FaRupeeSign, FaBath, FaWhatsapp, FaPhone } from "react-icons/fa";
import { faChair } from "@fortawesome/free-solid-svg-icons";
import { PiShareNetworkLight } from "react-icons/pi";
import { ShareNetwork } from "@phosphor-icons/react";
import { PiCubeFocus } from "react-icons/pi";
                ...
                {properties.length > 0 ? (
                  properties.map((property) => (
                    ...
                    >
                      ...
                      {/* Property Description (Spotlight style - same as FeaturedDashboard) */}
                      <div className="p-4 bg-white">
                        ...
                        <p className="mt-0 mb-2 text-sm leading-5 text-gray-500 truncate">
                          ...
                          {property.property_type || property.building_type || "Property"} for{" "}
                          {property.property_category_type === "Rent"
                            ? "Rent"
                            : "Sale"}{" "}
                          in {property.address_area || property.address || "No Address Provided"}
                        </p>
